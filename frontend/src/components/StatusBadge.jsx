const MAP = {
  ...
  open: ["รอจัดคิว", "bg-blue-400/10 text-blue-300 ring-blue-400/30", "bg-blue-400", "shadow-[0_0_8px_rgba(96,165,250,0.7)]"],
  ...
  resolved: ["ดำเนินการเรียบร้อย", "bg-green-400/10 text-green-300 ring-green-400/30", "bg-green-400", "shadow-[0_0_8px_rgba(74,222,128,0.7)]"],
  closed: ["ปิดงาน", "bg-slate-400/10 text-slate-300 ring-slate-400/30", "bg-slate-400", ""],
};
